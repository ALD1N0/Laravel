...
class TwebPendudukDeroController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        try {
            $query = TwebPendudukDero::query()->where('status_dasar', 1);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $penduduk = TwebPendudukDero::create($validated);
    ...
    public function update(Request $request, TwebPendudukDero $twebPendudukDero): JsonResponse
    {
        try {
            $validated = $request->validate([
    ...
    public function destroy(TwebPendudukDero $twebPendudukDero): JsonResponse
    {
        try {
